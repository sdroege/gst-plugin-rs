 ...
 *
 * |[
 * gst-launch-1.0 udpsrc2 address=127.0.0.1 port=5555 caps='application/x-rtp,media=video,clock-rate=90000,encoding-name=MPV' ! rtpjitterbuffer latency=100 ! rtpmpvdepay2 ! decodebin3 ! videoconvertscale ! autovideosink

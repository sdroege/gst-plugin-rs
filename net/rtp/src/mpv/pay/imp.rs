 ...
 *
 * |[
 * gst-launch-1.0 videotestsrc ! video/x-raw,width=1280,height=720,format=I420 ! timeoverlay font-desc=Sans,22 ! avenc_mpeg2video ! rtpmpvpay2 ! udpsink2 host=127.0.0.1 port=5004

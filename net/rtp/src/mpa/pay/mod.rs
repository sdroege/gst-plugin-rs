...
#[repr(i32)]
#[enum_type(name = "GstRtpMpegAudioPayAggregateMode")]
#[non_exhaustive]
pub(crate) enum RtpMpegAudioPayAggregateMode {
    #[enum_value(
...
glib::wrapper! {
    pub struct RtpMpegAudioPay(ObjectSubclass<imp::RtpMpegAudioPay>)
...
pub fn register(plugin: &gst::Plugin) -> Result<(), glib::BoolError> {
    #[cfg(feature = "doc")]
    {
        RtpMpegAudioPayAggregateMode::static_type()

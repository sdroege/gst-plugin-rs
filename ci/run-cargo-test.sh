...
for cfg in "",default "--all-features --exclude gst-plugin-gtk4 --exclude gst-plugin-whisper",all "--no-default-features --exclude gst-plugin-burn --exclude gst-plugin-webrtc --exclude gst-plugin-reqwest",no-default; do
